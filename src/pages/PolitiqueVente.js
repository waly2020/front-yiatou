...
const PolitiqueVente = () => {
    return (
        <div className='page textes-pages'>
            <Header classPage="notif">
                <ContentHeaderNotif texte="Politique de vente" back={true} color="black" backPage={useParams().back === 'compte' ? '/compte/demandeur' : '/compte/business'}></ContentHeaderNotif>
            </Header>
            <main className="body">
